<template>
  <div>
    <div class="cell">
      ...
      <bk-button style="margin-right: 20px" @click="handleClear">
        清理过滤条件
      </bk-button>
      <bk-button style="margin-right: 20px" @click="handleAdd"> 添加过滤 </bk-button>
      <bk-input v-model="filterValue" style="width: 120px" />
      <bk-table
