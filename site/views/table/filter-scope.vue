<template>
  <div>
    <div class="cell">
      ...
      <bk-table :columns="columns" :data="tableData" :pagination="pagination" @column-filter="handleFilter"
        @column-sort="handleSortBy" />
    </div>
    <div class="cell">
      <span class="title">filter scope = all, match = fuzzy,</span>
      <bk-table :columns="columns1" :data="tableData" :pagination="pagination" @dblclick="handleDblClick" />
    </div>
  </div>
</template>
